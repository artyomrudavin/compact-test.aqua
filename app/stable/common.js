...
$(function() {
	...
	$( '.c_fourteen' ).hover(
		function() {
			$(this).attr('src', 'img/catalog-lk/c_suh.jpg');
		}, function() {
			$(this).attr('src', 'img/catalog-lk/c_14litr.jpg');
		}
	);
	...
	$( '.c_twentyfive' ).hover(
		function() {
			...
			$(this).attr('src', 'img/catalog-lk/c_25litr.jpg');
		}
	);
	...
	$( '.c_thirtyfive' ).hover(
		function() {
			...
			$(this).attr('src', 'img/catalog-lk/c_35litr.jpg');
		}
	);
